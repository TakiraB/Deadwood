                       ...
                       switch (playerInput) {
                           ...
                           case "act":
                               if (activePlayer.getActiveRole() == null) {
                                ...
                                //            "You have already acted or rehearse this turn, you can do either next turn!");
                                           view.displayGameMessage("You have already acted or rehearse this turn, you can do either next turn!");
                                   break;
                               }
                           ...
                           case "rehearse":
                               if (activePlayer.getHasActed()) {
                                //    System.out.println(
                                //            "You have already acted or rehearse this turn, you can do either next turn!");
                                   view.displayGameMessage("You have already acted or rehearsed this turn, you can do either next turn!");
                                   break;
                               }
                           ...
                           case "upgrade":
                               ...
                               if (!activePlayer.getPlayerRoom().getName().equals("Casting Office")) {
                                ...
                                view.displayGameMessage("You are not in the Casting Office. To upgrade, please move to the Casting Office and try again");
                                   break;
                               }
                               ...
                               if (chosenPaymentType.equals("dollar")) {
                                ...
                                //            "You have either selected a rank or currency that exists. Please try again.");
                                    view.displayGameMessage("You have either selected a rank or currency that doesn't exist. Please try again.");
                               }
                               break;
